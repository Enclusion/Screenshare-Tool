...
#define InitializeMessageHeader( ph, l, t ) {                  \
	...
	NTSYSAPI
		NTSTATUS
		NTAPI ZwResumeThread(HANDLE ThreadHandle, PULONG PreviousSuspendCount);
	...
	NTSYSAPI
		NTSTATUS
		NTAPI
		RtlCompressBuffer(WORD CompressionFormatAndEngine, PVOID UncompressedBuffer, DWORD UncompressedBufferSize, PVOID CompressedBuffer, DWORD CompressedBufferSize, DWORD UncompressedChunkSize, PDWORD FinalCompressedSize, PVOID WorkSpace);

	NTSYSAPI
		NTSTATUS
		NTAPI
		RtlGetCompressionWorkSpaceSize(WORD CompressionFormatAndEngine, PDWORD CompressBufferWorkSpaceSize, PDWORD CompressFragmentWorkSpaceSize);

	NTSYSAPI
		NTSTATUS
		NTAPI
		RtlDecompressBuffer(WORD CompressionFormat, PVOID UncompressedBuffer, DWORD UncompressedBufferSize, PVOID CompressedBuffer, DWORD CompressedBufferSize, PDWORD FinalUncompressedSize);
...
#define RtlProcessHeap() (HANDLE)(NtCurrentTeb()->ProcessEnvironmentBlock->ProcessHeap)
	...
	NTSYSAPI
		...
		NtWriteVirtualMemory(
			...
			IN PVOID BaseAddress,
			IN PVOID Buffer,
			IN ULONG_PTR NumberOfBytesToWrite,
